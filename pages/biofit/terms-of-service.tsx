    ...
    <>
      ...
      <div className="mx-auto prose px-[5%] max-w-7xl py-12 leading-5">
        ...
        <p>
          ...
          use of Biofit Supplement Website, located at Biofit Supplement.
          <br />
          <br />
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use Biofit Supplement if you do not
        ...
        <h2>Cookies</h2>
        <p>
          We employ the use of cookies. By accessing Biofit Supplement, you
          agreed to use cookies in agreement with the Biofit Supplement's
          Privacy Policy.
          <br />
          <br />
        ...
        <h2>License</h2>
        <p>
          Unless otherwise stated, Biofit Supplement and/or its licensors own
          the intellectual property rights for all material on Biofit
          Supplement. All intellectual property rights are reserved. You may
          access this from Biofit Supplement for your own personal use subjected
          to restrictions set in these terms and conditions.
        </p>

        <h2>You must not</h2>
        <p>
          Republish material from Biofit Supplement
          <br />
          <br />
          Sell, rent or sub-license material from Biofit Supplement
          <br />
          <br />
          Reproduce, duplicate or copy material from Biofit Supplement
          <br />
          <br />
          Redistribute content from Biofit Supplement
          <br />
          <br />
          ...
          Biofit Supplement does not filter, edit, publish or review Comments
          prior to their presence on the website. Comments do not reflect the
          views and opinions of Biofit Supplement,its agents and/or affiliates.
          Comments reflect the views and opinions of the person who post their
          views and opinions. To the extent permitted by applicable laws, Biofit
          Supplement shall not be liable for the Comments or for any liability,
          ...
          <br />
          <br />
          Biofit Supplement reserves the right to monitor all Comments and to
        ...
        <p>
          ...
          <br />
          <br />
          You hereby grant Biofit Supplement a non-exclusive license to use,
        ...
        <p>
          ...
          the hyperlink compensates the absence of Biofit Supplement; and (d)
          ...
          sending an e-mail to Biofit Supplement. Please include your name, your
        ...
        <p>
          ...
          party’s site. <br /> <br />
          No use of Biofit Supplement's logo or other artwork will be allowed
