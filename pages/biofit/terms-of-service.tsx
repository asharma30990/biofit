    ...
    <>
      ...
      <div className="mx-auto prose px-[5%] max-w-7xl py-12 leading-5">
        ...
        <div>
          ...
          <p>
            This website (the "Site") is owned and operated by Biofit (“COMPANY”
            ...
            whether automated or otherwise, varitutes use of the Site and your
            agreement to be bound by these Terms of Service.
          </p>
          <p>
            We reserve the right to change these Terms of Service or to impose
            new conditions on use of the Site, from time to time, in which case
            we will post the revised Terms of Service on this website. By
            continuing to use the Site after we post any such changes, you
            accept the Terms of Service, as modified.
          </p>
          <h2>Intellectual Property Rights</h2>
          <p>
            <b>Our Limited License to You.</b> This Site and all the materials
            available on the Site are the property of us and/or our affiliates
            or licensors, and are protected by copyright, trademark, and other
            intellectual property laws. The Site is provided solely for your
            personal noncommercial use. You may not use the Site or the
            materials available on the Site in a manner that varitutes an
            ...
            reproduce, republish, upload, post, transmit, translate, sell,
            create derivative works, exploit, or distribute in any manner or
            medium (including by email or other electronic means) any material
            from the Site. You may, however, from time to time, download and/or
          ...
          <p>
            <b>Your License to Us.</b> By posting or submitting any material
          ...
          <p>
            ...
            hire in Section 101 of the United States Copyright Law, as amended.
            As such, the copyrights in those works shall belong to COMPANY from
            their creation. Thus, COMPANY shall be deemed the author and
            exclusive owner thereof and shall have the right to exploit any or
            ...
            languages, as COMPANY determines. In the event that any of the
            results and proceeds of your submissions hereunder are not deemed a
            “work made for hire” under Section 101 of the Copyright Act, as
            amended, you hereby, without additional compensation, irrevocably
            assign, convey and transfer to COMPANY all proprietary rights,
            ...
            known or hereafter devised, to such material and any and all right,
            title and interest in and to all such proprietary rights in every
            medium, whether now known or hereafter devised, throughout the
            universe, in perpetuity. Any posted material which are reproductions
          ...
          <p>
            <b>Limitations on Linking and Framing.</b> You may establish a
          ...
          <p>
            ...
            sites. In addition, neither we nor affiliates operate or control in
            any respect any information, products or services that third parties
            may provide on or through the Site or on websites linked to by us on
            the Site.
          </p>
          <p>
          ...
          <p>
            ...
            OR THAT ANY PART OF THIS SITE, INCLUDING BULLETIN BOARDS, OR THE
          ...
          <p>
            ...
            visit to that merchant's online store or site, and the information
            that you give as part of the transaction, such as your credit card
            number and contact information, may be collected by both the
            merchant and us. A merchant may have privacy and data collection
            practices that are different from ours. We have no responsibility or
            liability for these independent policies. In addition, when you
            purchase products or services on or through the Site, you may be
            subject to additional terms and conditions that specifically apply
            to your purchase or use of such products or services. For more
            information regarding a merchant, its online store, its privacy
            policies, and/or any additional terms and conditions that may apply,
            visit that merchant's website and click on its information links or
            contact the merchant directly. You release us and our affiliates
            from any damages that you incur, and agree not to assert any claims
          ...
          <p>
            ...
            messages, information or files that you or others may provide
          ...
          <ul>
            ...
            <li>
              ...
              limitation any transmissions varituting or encouraging conduct
              that would varitute a criminal offense, give rise to civil
          ...
          <p>
            COMPANY may host message boards, chats and other private/public
            forums on its Sites and on other platforms. Any user failing to
            comply with the terms and conditions of this Agreement may be
            expelled from and refused continued access to, the message boards,
            groups, chats or other such forums in the future. COMPANY or its
            designated agents may remove or alter any user-created content at
            any time for any reason. Message boards, chats and other public
            ...
            contributors, or by users not connected with COMPANY, some of whom
            ...
            displayed in these forums by third parties, nor are we responsible
            for any errors or omissions in such postings, or for hyperlinks
            embedded in any messages. Under no circumstances will we, our
            affiliates, suppliers or agents be liable for any loss or damage
            caused by your reliance on information obtained through these
            forums. The opinions expressed in these forums are solely the
            opinions of the participants, and do not reflect the opinions of
            COMPANY or any of its subsidiaries or affiliates.
          </p>
          <p>
            COMPANY has no obligation whatsoever to monitor any of the content
            or postings on the message boards, chat rooms or other public forums
          ...
          <p>
            ...
            birth, zip code and country. In addition, if you elect to sign-up
            for a particular feature of the Site, such as chat rooms, web logs,
            or bulletin boards, you may also be asked to register with us on the
            form provided and such registration may require you to provide
            ...
            form. If we have reasonable grounds to suspect that such information
            is untrue, inaccurate, or incomplete, we have the right to suspend
            or terminate your account and refuse any and all current or future
            use of the Site (or any portion thereof). Our use of any personally
            identifiable information you provide to us as part of the
          ...
          <p>
            ...
            the password and account, and are responsible for all activities
            ...
            of your password or account or any other breach of security, and to
          ...
          <p>
            The Biofit mobile message service (the "Service") is operated by
            Nature’s Formulas(“Nature’s Formulas ”, “we”, or “us”). Your use of
            the Service constitutes your agreement to these terms and conditions
            (“Mobile Terms”). We may modify or cancel the Service or any of its
            features without notice. We may also modify these Mobile Terms at
            any time and your continued use of the Service following the
            effective date of any such changes shall constitute your acceptance
            of such changes.
          </p>
          <p>
            ...
            wireless provider. Message and data rates may apply.
          </p>
          <p>
            Text messages may be sent using an automatic telephone dialing
            system or other technology. Your consent to receive autodialed
            marketing text messages is not required as a condition of purchasing
            any goods or services. If you have opted in, the Service provides
            updates, alerts, information, promotions, specials, and other
            marketing offers from Nature’s Formulas via text messages through
            your wireless provider to the mobile number you provided. Message
            frequency is recurring. Text the single keyword command STOP, CANCEL
            or UNSUBSCRIBE to tel:+1-209-317-9387 to cancel at any time. You'll
            receive a one-time opt-out confirmation text message. If you have
            subscribed to other Nature’s Formulas mobile message programs and
            wish to cancel, you will need to opt out separately from those
            programs by following the instructions provided in their respective
            mobile terms. For Service support or assistance, email
            support@getbiofit.com We may change any short code or telephone
            number we use to operate the Service at any time. You acknowledge
            that any messages, including any STOP, CANCEL or UNSUBSCRIBE
          ...
          <p>
            ...
            valid mobile number. If you change your mobile phone number, you
            agree to opt out of the Service prior to changing your mobile
            number. You agree to indemnify, defend, and hold us harmless from
            any third-party claims, liability, damages or costs arising from
            your use of the Service or from you providing us with a phone number
            that is not your own.
          </p>
          <p>
            You agree that we will not be liable for failed, delayed, or
            misdirected delivery of any information sent through the Service,
            any errors in such information, and/or any action you may or may not
          ...
          <p>
            ...
            OTHERS, BOOKS, EMAILS, PRODUCTS, OR SERVICES, OR THIRD-PARTY
            MATERIALS, PRODUCTS, OR SERVICES MADE AVAILABLE THROUGH THE SITE OR
            ...
            LIMITATION MAY NOT APPLY TO YOU. IN SUCH STATES, OUR LIABILITY AND
            THE LIABILITY OF OUR SUBSIDIARY AND PARENT COMPANIES OR AFFILIATES
            IS LIMITED TO THE FULLEST EXTENT PERMITTED BY SUCH STATE LAW.) YOU
          ...
          <h2>Refund Policy</h2>
          <p>
            In order to obtain your full refund, contact customer service by
            email at support@goBiofit.com phone at 1-866-450-0608 with your
            email address and/or order number in order to request a refund. You
            had 180 days from date of purchase to make request for a full
            refund. Your refund will be credited back to your bank account, and
            may take up to 3-5 business days to show in your statement,
          ...
          <p>
            ...
            you believe in good faith that materials hosted by COMPANY infringe
            your copyright, you, or your agent may send to COMPANY a notice
            requesting that the material be removed or access to it be blocked.
            ...
            filed against you, the DMCA permits you to send to COMPANY a
          ...
          <p>
            ...
            be assigned without the prior written consent of COMPANY
            Notwithstanding the foregoing, all rights and obligations under this
            Agreement may be freely assigned by COMPANY to any affiliated entity
            or any of its wholly owned subsidiaries.
          </p>
          <h2>Dispute Resolution</h2>
          <p>
            These Terms of Use shall be governed by and varrued in accordance
            with the laws of the State of Barbados and any dispute shall be
            subject to binding arbitration in St. Michael, Barbados. If any
