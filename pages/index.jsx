  ...
  return (
    <>
      ...
      <div className="flex justify-center pt-10">
        <img className="w-full max-w-screen-md" src="/images/86714.png" alt="" />
      </div>
      ...
      <div className="bg-purple-800">
        <div className="relative z-0 container max-w-screen-xl px-5 md:px-[5%] mx-auto py-6 flex flex-col items-center text-center text-white">
          <div className="flex flex-col items-center justify-center gap-2 pt-4 text-sm text-center max-w-5xl">
