        ...
        <div className="relative">
          <div className="lg:mx-auto lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-2 lg:grid-flow-col-dense lg:gap-24">
            ...
            <div className="relative mt-12 sm:mt-16 lg:mt-0">
              <div
                className={`absolute shadow-lg z-10 p-4 text-white font-bold -translate-x-1/2 bg-blue-500 centre-1/2 w-fit -bottom-10 flex-col justify-centre items-centre text-centre rounded-xl ${
                  banner ? 'hidden' : 'flex'
                }`}
              >
