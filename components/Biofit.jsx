            ...
            <div className="mt-6 text-center">
              <a className="inline-flex text-base font-medium group">
                <ShieldCheckIcon
                  ...
                  aria-hidden="true"
                />
                <span className="text-gray-500 hover:text-gray-700">[Limited Supplies] Lowest Price Guaranteed Click The Button To Buy Biofit™ 180 Days Moneyback Guarantee</span>
              </a>
            </div>
          </section>
        </div>
